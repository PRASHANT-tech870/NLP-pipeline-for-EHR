...
train_generator=train_datagen.flow_from_directory(
    'D:\BRAIN PROJECT\Archive_tumor_kaggle\Training',
    target_size=(224,224),
    batch_size=32,
...
validation_generator=train_datagen.flow_from_directory(
    'D:\BRAIN PROJECT\Archive_tumor_kaggle\Validation',
    target_size=(224,224),
    batch_size=32,
    class_mode='categorical',
    subset='validation'
...
test_generator=test_datagen.flow_from_directory(
    'D:\BRAIN PROJECT\Archive_tumor_kaggle\Testing',
    target_size=(224,224),
    batch_size=32,
    class_mode='categorical'
)
...
for i in range(len(predicted_labels)):
    ...
    print('Predicted class:', class_labels[predicted_labels[i]])
    print('Probability:', predicted_probabilities[i])
